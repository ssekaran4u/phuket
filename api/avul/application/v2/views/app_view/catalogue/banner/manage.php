                    ...
                    <section class="app-user-list">
                        ...
                        <div class="card">
                            <div class="card-body border-bottom">
                                <h4 class="card-title"><?php echo $sub_heading; ?></h4>
                            </div>
                                            ...
                                            <table class="user-list-table table">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="sorting" data-item="2" data-sort="1">Banner Name
                                                            <span class="hide up">&#8673;</span>
                                                            <span class="hide down">&#8675;</span>
                                                        </th>
                                                        <th class="sorting" data-item="3" data-sort="1">Banner Type
                                                            <span class="hide up">&#8673;</span>
                                                            <span class="hide down">&#8675;</span>
                                                        </th>

                                                        <th class="sorting" data-item="4" data-sort="1">Banner Position
                                                            <span class="hide up">&#8673;</span>
                                                            <span class="hide down">&#8675;</span>
                                                        </th>
                                                        <th class="sorting" data-item="5" data-sort="1">Image
                                                            <span class="hide up">&#8673;</span>
                                                            <span class="hide down">&#8675;</span>
                                                        </th>
                                                        <th class="sorting" data-item="6" data-sort="1">Status
                                                            <span class="hide up">&#8673;</span>
                                                            <span class="hide down">&#8675;</span>
                                                        </th>
                                                        <th class="sorting" data-item="7" data-sort="1">Created At
                                                            <span class="hide up">&#8673;</span>
                                                            <span class="hide down">&#8675;</span>
                                                        </th>
                                                        <?php
