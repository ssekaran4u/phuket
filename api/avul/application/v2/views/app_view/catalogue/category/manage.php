                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-2">
                                <div class="form-check form-check-inline mt-2">
                                    <input class="form-check-input" type="checkbox" id="n_parent" value="1" />
                                    <label class="form-check-label" for="n_parent">Main categories</label>
                                </div>
                            </div>
                            <div class="col-sm-12 col-lg-3">
                                <div class="form-group mt-1">
                                    <select class="select2 form-select" id="n_category" name="n_category">
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="table_value hide">
                                    ...
                                    <table class="user-list-table table">
                                        <thead class="table-light">
                                            <tr>
                                                <th class="sorting active" data-item="1" data-sort="1">Sort
                                                    <span class="show-inline up">&#8673;</span>
                                                    <span class="hide down">&#8675;</span>
                                                </th>
                                                <th class="sorting" data-item="2" data-sort="1">Category Name
                                                    <span class="hide up">&#8673;</span>
                                                    <span class="hide down">&#8675;</span>
                                                </th>
                                                <th class="sorting" data-item="3" data-sort="1">Parent Category
                                                    <span class="hide up">&#8673;</span>
                                                    <span class="hide down">&#8675;</span>
                                                </th>
                                                <th>Image</th>
                                                <th class="sorting" data-item="4" data-sort="1">Status
                                                    <span class="hide up">&#8673;</span>
                                                    <span class="hide down">&#8675;</span>
                                                </th>
                                                <th class="sorting" data-item="5" data-sort="1">Created At
                                                    <span class="hide up">&#8673;</span>
                                                    <span class="hide down">&#8675;</span>
                                                </th>
                                                <th>Actions</th>
