<?php
    ...
    $c_demographic = isset($dataval->c_demographic) ? explode(",",$dataval->c_demographic) :'';
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-md-7">
                                                        <div class="row clearfix">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-1">
                                                                    <label class="form-label" for="n_city">City <span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-1">
                                                                    <label class="form-label" for="first-name-column">District <span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-1">
                                                                    <label class="form-label" for="first-name-column">Town <span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-1">
                                                                    <label class="form-label" for="first-name-column">Category <span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="mb-1">
                                                                    <label class="form-label" for="first-name-column">Latitude <span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="mb-1">
                                                                    <label class="form-label" for="first-name-column">Longitude <span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-1">
                                                                    <label class="form-label" for="first-name-column">Name in Thai <span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="mb-1">
                                                                    <label class="form-label" for="first-name-column">Address <span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="country_lists">
                                                                    <div class="mb-1 position-relative">
                                                                        <label class="form-label" for="c_mobile_numbers">Mobile Number <span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-1">
                                                                    <label class="form-label" for="first-name-column">Business Email Id <span class="text-danger">*</span> </label>
                                    ...
                                    <div id="accordionMarginTwo" class="accordion-collapse collapse" aria-labelledby="headingMarginTwo" data-bs-parent="#accordionMargin">
                                            <div class="accordion-body">
                                                <div class="row clearfix">
                                                    <div class="col-md-6">
                                                        <div class="mb-1">
                                                            <label class="form-label" for="first-name-column">Contact person full name <span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control input_field" placeholder="Contact Number" name="c_c_full_name" value="<?php echo !empty($c_c_full_name) ? $c_c_full_name : '' ?>" />
                                                        </div>
                                                    </div>

                                                    <div class="col-md-6">
                                                        <div class="mb-1">
                                                            <label class="form-label" for="first-name-column">Contact person short name <span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control input_field" placeholder="Contact person short name" name="c_c_short_name" value="<?php echo !empty($c_c_short_name) ? $c_c_short_name : '' ?>" />
                                                        </div>
                                                    </div>

                                                    <div class="col-md-3 country_lists">
                                                        <div class="mb-1 position-relative">
                                                            <label class="form-label" for="c_c_contact_number">Contact Number <span class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-7"
                                                        ...
                                                        <div class="row clearfix">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="country_lists">
                                                                    <div class="mb-1 position-relative">
                                                                        <label class="form-label" for="c_c_whatsapp">WhatsApp Number <span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="country_lists">
                                                                    <div class="mb-1 position-relative">
                                                                        <label class="form-label" for="c_c_line">Line Number <span class="text-danger">*</span></label>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="accordionMarginThree" class="accordion-collapse collapse" aria-labelledby="headingMarginThree" data-bs-parent="#accordionMargin">
                                            <div class="accordion-body">
                                                <div class="row clearfix">
                                                    <div class="col-md-12">
                                                        <label class="form-label" for="first-name-column">Working Hours <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-md-12">
                                        ...
                                        <div id="accordionMarginFour" class="accordion-collapse collapse" aria-labelledby="headingMarginFour" data-bs-parent="#accordionMargin">
                                            <div class="accordion-body">
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-1">
                                                            <label class="form-label" for="first-name-column">Terms &amp; Conditions <span class="text-danger">*</span></label>
                                                            <textarea rows="5" name="c_terms" class="form-control plocation" placeholder="Provide terms &amp; conditions"><?php echo $c_terms; ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <button type="button" class="btn btn-primary me-1 openFive">
                                                            <span class="first_btn"> <i class="icon-paper-plane"></i> Next</span>
                                                        </button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-check form-check-success">
                                                <div class="accordion-body">
                                                    <div class="row clearfix mb-1">
                                                        <?php 
                                                        if(!empty($geo_list)):
                                                            foreach ($geo_list as $gkey => $geo) {
                                                        ?>
                                                        <div class="col-md-2">
                                                            <div class="form-check form-check-success">
                                                                <input name="n_demographic[]" value="<?php echo $geo->n_id; ?>" type="checkbox" class="form-check-input" id="geoCheck<?php echo $gkey+1; ?>"
                                                                <?php if($method == '_Edit'): 
                                                                    if(!empty($c_demographic))
                                                                    {
                                                                        echo in_array($geo->n_id, $c_demographic) ? 'checked' : '';
                                                                    }
                                                                    endif; 
                                                                ?>
                                                                 />
                                                                <label class="form-check-label" for="geoCheck<?php echo $gkey+1; ?>"><?php echo $geo->c_demographic; ?></label>
                                                            </div>
                                                        </div>
                                                        <?php } endif; ?>
                                                    </div>
