                    ...
                    <section class="app-user-list">
                        ...
                        <div class="card">
                            <div class="card-body border-bottom">
                                <h4 class="card-title mb-0"><?php echo $sub_heading; ?></h4>
                            </div>
                                            ...
                                            <table class="user-list-table table">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="sorting" data-item="2" data-sort="1">Page Name
                                                            <span class="hide up">&#8673;</span>
                                                            <span class="hide down">&#8675;</span>
                                                        </th>
                                                        <th class="sorting" data-item="3" data-sort="1">Page Type
                                                            <span class="hide up">&#8673;</span>
                                                            <span class="hide down">&#8675;</span>
                                                        </th>
                                                        ...
                                                        <th class="sorting" data-item="5" data-sort="1">Created Date
                                                            <span class="hide up">&#8673;</span>
                                                            <span class="hide down">&#8675;</span>
                                                        </th>
                                                        <th>Action</th>
