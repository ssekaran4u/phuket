                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-4">
                                <div class="form-group mt-1">
                                    <select class="select2 form-select" id="n_city" name="n_city">
                                        ...
                                        <?php
                                            if(!empty($city_val))
                                            {
                                                foreach ($city_val as $key => $val_1) {
                                                    ...
                                                    echo '<option value="'.$s_id.'">'.$c_city.'</option>';
                                                }
                                            }
                                        ?>
                                    </select>
                                    ...
                                    <table class="user-list-table table">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sorting" data-item="2" data-sort="1">District
                                                    <span class="hide up">&#8673;</span>
                                                    <span class="hide down">&#8675;</span>
                                                </th>
                                                <th class="sorting" data-item="3" data-sort="1">City
                                                    <span class="hide up">&#8673;</span>
                                                    <span class="hide down">&#8675;</span>
                                                </th>
